...
class MockGLPIService:
    ...
    def get_ticket_by_id(self, ticket_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "content": f"Descrição detalhada do ticket {ticket_id} - Problema simulado para demonstração",
            ...
            "solvedate": (datetime.now() - timedelta(days=random.randint(0, 5))).isoformat() if random.choice([True, False]) else None,
    ...
    def get_dashboard_metrics_with_modification_date_filter(self, start_date=None, end_date=None, correlation_id=None) -> Dict[str, Any]:
        """Mock das métricas do dashboard com filtro de data de modificação"""
        return self.get_dashboard_metrics(correlation_id=correlation_id)
    
    def get_dashboard_metrics_with_filters(self, start_date=None, end_date=None, status=None, priority=None, level=None, technician=None, category=None, correlation_id=None) -> Dict[str, Any]:
    ...
    def get_ticket_details(self, ticket_id: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "content": f"Descrição completa do ticket {ticket_id} com mais detalhes para visualização",
            "date": (datetime.now() - timedelta(hours=random.randint(1, 48))).isoformat(),
            "users_id": random.randint(100, 200),
            "priority": random.randint(1, 4),
            "itilcategories_id": random.randint(1, 10),
