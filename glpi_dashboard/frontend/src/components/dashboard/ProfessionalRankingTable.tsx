          ...
          <div className="flex flex-col gap-1">
            ...
            {filters && (filters.start_date || filters.end_date || filters.level) && (
              <div className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400">
                ...
                {filters.start_date && (
                  <Badge variant="outline" className="text-xs px-2 py-1 bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300">
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center p-8 space-y-4">
            ...
            <div className="text-center">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Carregando Ranking</h3>
            ...
            <div className="w-full max-w-xs bg-gray-200 dark:bg-gray-700 rounded-full h-2">
              <div className="bg-gray-600 dark:bg-gray-500 h-2 rounded-full animate-pulse" style={{width: '60%'}}></div>
            </div>
          </div>
