    ...
    return (
      ...
      >
        <div className='flex items-start space-x-3'>
          <Icon
            className={cn('h-5 w-5 mt-0.5 flex-shrink-0', variantConfig.iconColor)}
            aria-hidden='true'
          />
        ...
        {onClose && (
          <button
            ...
            className={cn(
              ...
              variant === 'default' &&
                'focus:ring-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700',
              variant === 'success' &&
                'focus:ring-green-400 hover:bg-green-100 dark:hover:bg-green-800',
              variant === 'error' && 'focus:ring-red-400 hover:bg-red-100 dark:hover:bg-red-800',
              variant === 'warning' &&
                'focus:ring-yellow-400 hover:bg-yellow-100 dark:hover:bg-yellow-800',
