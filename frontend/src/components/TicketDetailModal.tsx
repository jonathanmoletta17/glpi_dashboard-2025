  ...
  return (
    <Dialog open={isOpen} onOpenChange={open => !open && onClose()}>
      <DialogContent className='max-w-5xl w-full max-h-[90vh] overflow-hidden flex flex-col'>
        <DialogHeader>
          <DialogTitle>{ticket ? `${ticket.title}` : 'Detalhes do Ticket'}</DialogTitle>
          <DialogDescription>
            <VisuallyHidden>
              {ticket
                ? `Visualizando detalhes do ticket ${ticket.id} - ${ticket.title}`
                  ...
                  <div className='bg-white border border-gray-200 rounded-lg p-4'>
                    ...
                    <div className='space-y-3'>
                      ...
                      <div>
                        ...
                        <span
                          className={`inline-flex items-center px-2 py-1 rounded-md text-xs font-medium ${getPriorityColor(ticket.priority)}`}
                        >
                    ...
                    <div className='space-y-3'>
                      ...
                      {ticket.timeTracking && (
                        <div>
                          ...
                          <p className='text-sm text-gray-900 dark:text-white'>
                            {Math.floor(ticket.timeTracking.totalTime / 60)}h{' '}
                            {ticket.timeTracking.totalTime % 60}m
                          </p>
                        </div>
                      )}
                    </div>
